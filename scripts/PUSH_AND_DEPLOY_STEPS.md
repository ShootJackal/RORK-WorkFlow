...
- Make sure you’re in the project: `cd /Users/keith.stine/RORK-WorkFlow` (if needed).
...
This updates the script that your Google Sheet runs so it matches the code in the repo (v4.2, Task Actuals / Collector Actuals sheet name handling).
...
- **Part 2**: The Google Sheet is running the updated script (v4.2) with the correct sheet name handling.
